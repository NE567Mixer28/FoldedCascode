...
C {devices/lab_pin.sym} -910 -500 0 0 {name=p36 sig_type=std_logic lab=VDD}
C {devices/lab_pin.sym} -910 -300 0 0 {name=p37 sig_type=std_logic lab=GND}
...
C {sky130_fd_pr/res_xhigh_po.sym} -910 -360 0 0 {name=R5
W=0.35
L=3.2
model=res_xhigh_po
spiceprefix=X
mult=1}
C {sky130_fd_pr/res_xhigh_po.sym} -910 -450 0 0 {name=R1
W=0.35
L=5
model=res_xhigh_po
spiceprefix=X
mult=1}
C {sky130_fd_pr/res_xhigh_po.sym} -750 -450 0 0 {name=R2
W=0.35
L=5
model=res_xhigh_po
spiceprefix=X
mult=1}
C {sky130_fd_pr/res_xhigh_po.sym} -750 -360 0 0 {name=R3
W=0.35
L=1.94
model=res_xhigh_po
spiceprefix=X
...
C {devices/iopin.sym} -880 -410 0 0 {name=p8 lab=Vc}
C {devices/iopin.sym} -720 -410 0 0 {name=p9 lab=Vp}
